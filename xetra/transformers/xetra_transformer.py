...
class XetraTargetConfig(NamedTuple):
    ...
    trg_col_date: column name for date in ratget
    ...
    trg_key_date_format: data format of target file key
    trg_format: basic file format of target file   
    """
    trg_col_isin: str
    trg_col_date: str
...
class XetraETL():
    ...
    def __init__(self, s3_bucket_src: S3BucketConnector,
        ...
        :param src_args: NamedTouple class with source configuration file
        :param trg_args: NamedTouple class with target configuration file
        """       
    ...
    def extract(self):
        ...
        """
        self._logger.info('Extrcating Xetra source files started...')
        ...
        self._logger.info('Extrcating Xetra source files finished.')
        return data_frame
    ...
    def transform_report1(self, data_frame: pd.DataFrame):
        ...
        # Calculating opening prices per ISIN and day
        ...
        # Aggregating per ISIN and day -> opening price, closing price, mini price, max price,traded volume
    ...
    def load(self, data_frame: pd.DataFrame):
      ...
      """  
      # Creating target key
      target_key = (f'{self.trg_args.trg_key}'
